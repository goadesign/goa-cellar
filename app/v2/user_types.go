//************************************************************************//
// API "cellar" version 2.0: Application User Types
//
...
// GenericBottlePayload type
type GenericBottlePayload struct {
...
func (ut *GenericBottlePayload) Validate() (err error) {
	if ut.Color != nil {
	...
	if ut.Kind != nil {
		if !(*ut.Kind == "wine" || *ut.Kind == "rum") {
			err = goa.InvalidEnumValueError(`response.kind`, *ut.Kind, []interface{}{"wine", "rum"}, err)
		}
	}
	if ut.Name != nil {
		if len(*ut.Name) < 2 {
