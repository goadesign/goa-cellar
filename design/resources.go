...
var _ = Resource("generic_bottle", func() {
	DefaultMedia(GenericBottle)
	BasePath("bottles")
	APIVersion("2.0")
	Parent("account")
	...
	Action("list", func() {
		...
		Response(OK, func() {
			Media(CollectionOf(GenericBottle, func() {
				View("default")
				View("tiny")
			}))
		})
	...
	Action("create", func() {
		...
		Payload(GenericBottlePayload, func() {
			Required("name", "kind", "vineyard", "varietal", "vintage", "color")
		})
