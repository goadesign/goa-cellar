...
// Generic bottle represents both wine and rum bottles.
var GenericBottle = MediaType("application/vnd.generic.bottle+json", func() {
	Description("A bottle of rum or wine")
	Reference(Bottle)
	APIVersion("2.0")
	Attributes(func() {
		Attribute("id")
		...
		Attribute("updated_at")
		Attribute("name")
		Attribute("kind", String, "The kind of bottle", func() {
			Enum("wine", "rum")
		})
		Attribute("vineyard")
		Attribute("varietal")
		...
		Required("id", "href", "kind", "name", "vineyard", "varietal", "vintage", "color")
	})
